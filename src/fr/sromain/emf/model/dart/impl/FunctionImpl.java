 ...
 * </p>
 * <ul>
 *   <li>{@link fr.sromain.emf.model.dart.impl.FunctionImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.sromain.emf.model.dart.impl.FunctionImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link fr.sromain.emf.model.dart.impl.FunctionImpl#getType <em>Type</em>}</li>
 *   <li>{@link fr.sromain.emf.model.dart.impl.FunctionImpl#isAbstract <em>Abstract</em>}</li>
 *   <li>{@link fr.sromain.emf.model.dart.impl.FunctionImpl#isStatic <em>Static</em>}</li>
 *   <li>{@link fr.sromain.emf.model.dart.impl.FunctionImpl#getBody <em>Body</em>}</li>
 *   <li>{@link fr.sromain.emf.model.dart.impl.FunctionImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link fr.sromain.emf.model.dart.impl.FunctionImpl#getMetadata <em>Metadata</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionImpl extends MinimalEObjectImpl.Container implements Function {
	...
	public Type getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DartPackage.FUNCTION__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this, DartPackage.FUNCTION__PARAMETERS);
		}
		return parameters;
	}
