...
public class DartSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DartPackage.FOLDER: {
				...
				if (result == null) result = caseAsset(folder);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.PACKAGE: {
				fr.sromain.emf.model.dart.Package package_ = (fr.sromain.emf.model.dart.Package)theEObject;
			...
			case DartPackage.DART_RESOURCE: {
				...
				if (result == null) result = caseAsset(dartResource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DartPackage.LIBRARY: {
				...
				if (result == null) result = caseDartResource(library);
				if (result == null) result = caseAsset(library);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.PART: {
				...
				if (result == null) result = caseDartResource(part);
				if (result == null) result = caseAsset(part);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.CLASSIFIER: {
				...
				if (result == null) result = casePart(classifier);
				if (result == null) result = caseDartResource(classifier);
				if (result == null) result = caseAsset(classifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.METADATA: {
				...
				if (result == null) result = caseClassifier(metadata);
				if (result == null) result = casePart(metadata);
				if (result == null) result = caseDartResource(metadata);
				if (result == null) result = caseAsset(metadata);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.CLASS: {
				fr.sromain.emf.model.dart.Class class_ = (fr.sromain.emf.model.dart.Class)theEObject;
				T result = caseClass(class_);
				if (result == null) result = caseClassifier(class_);
				if (result == null) result = caseType(class_);
				if (result == null) result = casePart(class_);
				if (result == null) result = caseDartResource(class_);
				if (result == null) result = caseAsset(class_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DartPackage.HTML: {
				...
				if (result == null) result = caseAsset(html);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.STYLESHEET: {
				...
				if (result == null) result = caseAsset(stylesheet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.MODULE: {
				fr.sromain.emf.model.dart.Module module = (fr.sromain.emf.model.dart.Module)theEObject;
				T result = caseModule(module);
				if (result == null) result = casePart(module);
				if (result == null) result = caseDartResource(module);
				if (result == null) result = caseAsset(module);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case DartPackage.CONTROLLER: {
				...
				if (result == null) result = caseAngularType(controller);
				if (result == null) result = caseClassifier(controller);
				if (result == null) result = caseType(controller);
				if (result == null) result = casePart(controller);
				if (result == null) result = caseDartResource(controller);
				if (result == null) result = caseAsset(controller);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.COMPONENT: {
				...
				if (result == null) result = caseAngularType(component);
				if (result == null) result = caseClassifier(component);
				if (result == null) result = caseType(component);
				if (result == null) result = casePart(component);
				if (result == null) result = caseDartResource(component);
				if (result == null) result = caseAsset(component);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.DECORATOR: {
				...
				if (result == null) result = caseClass(decorator);
				if (result == null) result = caseAngularType(decorator);
				if (result == null) result = caseClassifier(decorator);
				if (result == null) result = caseType(decorator);
				if (result == null) result = casePart(decorator);
				if (result == null) result = caseDartResource(decorator);
				if (result == null) result = caseAsset(decorator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DartPackage.FORMATTER: {
				...
				if (result == null) result = caseClass(formatter);
				if (result == null) result = caseAngularType(formatter);
				if (result == null) result = caseClassifier(formatter);
				if (result == null) result = caseType(formatter);
				if (result == null) result = casePart(formatter);
				if (result == null) result = caseDartResource(formatter);
				if (result == null) result = caseAsset(formatter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T casePackage(fr.sromain.emf.model.dart.Package object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseClass(fr.sromain.emf.model.dart.Class object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseModule(fr.sromain.emf.model.dart.Module object) {
		return null;
	}
